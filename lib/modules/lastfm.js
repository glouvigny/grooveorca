define(function (require, exports, module) {
    ...
    var Lastfm = function (router) {
        ...
        Persistance.get('lastfm_token', null)
            .then(function (token) {
    ...
    Lastfm.prototype.routes.player_song_changed = function (options) {
        ...
        this.context.current.disable = false;
    ...
    Lastfm.prototype.routes.player_unload = function (options) {
        ...
        this.context.position = 0;
        this.context.start_timestamp = 0;
        this.context.wiki_artist = null;
        this.context.artist_picture = null;
        this.context.playcount_track = 0;
        this.context.wiki_track = null;
        this.context.loved = false;
        this.context.playcount_artist = 0;
    ...
    Lastfm.prototype.routes.lastfm_page = function (options) {
        return Templating.render('templates/lastfm.mst', this.context)
            .then(function (view) {
    ...
    Lastfm.prototype.routes.lastfm_auth = function (options) {
        ...
        return LastfmApi.auth.getToken()
            .then(function (data) {
                ...
                return Persistance.set('lastfm_token', token);
            }.bind(this))
            .then(function () {
                this.context.token = token;
    ...
    Lastfm.prototype.routes.lastfm_disable_song = function (options) {
        this.context.current.disable = true;

        return this._reload();
    };

    Lastfm.prototype.routes.lastfm_enable_song = function (options) {
        this.context.current.disable = false;
